$(function(){
    ...
    // 하단 화살표 클릭시 최상단으로 가게 하기
    $(".btn_top, .logo").on("click", function(){
        $("html, body").animate({scrollTop:0},400);
    });

    // 스크롤 이동 시 해당영역인 메뉴색과 라인색 변경 / && (=and, 그리고)
    $(window).scroll(function(){
    ...
    // 각 메뉴 클릭 시 컨텐츠 영역의 아이디 값을 가진 곳으로 이동
    // .position() - 포지션 기준이 되는 요소를 기준으로 선택한 요소에서 가로/세로 떨어진 위치의 좌표값을 반환하거나 변경할 때 사용
    // about
